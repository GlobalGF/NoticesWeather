 ...
 * Variables: [NOMBRE], [CCAA], [PROVINCIA], [PCT], [MAX_EUR], [PROGRAMA], [HORAS_SOL], [RADIACION], [BONIF_IBI]
 */
...
{Al combinar la eficiencia de los paneles solares con la subvención del [PCT]%|Sumando las ayudas fotovoltaicas al recurso solar de [MUNICIPIO]}, {la amortización de las placas solares|el retorno de la inversión para tu vivienda|el periodo de recuperación de la instalación} {se sitúa entre 5 y 7 años|es extremadamente rápido}, {posicionando a [MUNICIPIO] como un lugar ideal para el autoconsumo|haciendo que las instalaciones solares sean la mejor decisión energética actualmente}.`,

  // ═══════════════════════════════════════════════════════
  // NIVEL MUNICIPIO — IBI activo
  // ═══════════════════════════════════════════════════════
  municipio_ibi_activo: `{Una de las mayores ventajas de instalar placas solares en [MUNICIPIO] son las bonificaciones fiscales locales|Además de las subvenciones solares, [MUNICIPIO] ofrece incentivos tributarios clave|Las empresas de instalaciones solares en [MUNICIPIO] destacan siempre las ayudas del ayuntamiento}. El consistorio {ofrece|aplica|concede} una {bonificación del IBI|reducción en el Impuesto de Bienes Inmuebles} del [BONIF_IBI]% {para viviendas con energía fotovoltaica|por instalar paneles solares|a quienes apuesten por el autoconsumo solar}.
{Este ahorro en el IBI|Esta bonificación municipal|Este incentivo por eficiencia energética} {es compatible con las subvenciones estatales para placas|se acumula al programa [PROGRAMA]|se suma a las ayudas de [CCAA]}, {lo que reduce drásticamente el coste real de la vivienda|multiplicando el ahorro anual de tu instalación solar}. {Muchas empresas de placas solares en [MUNICIPIO] recomiendan tramitar esta ayuda local cuanto antes|Esto hace que instalar paneles solares en [MUNICIPIO] sea más rentable que nunca}.`,

  // ═══════════════════════════════════════════════════════
  // NIVEL MUNICIPIO — IBI no activo
  // ═══════════════════════════════════════════════════════
  municipio_ibi_inactivo: `{Aunque [MUNICIPIO] no disponga de bonificación de IBI activa por instalar placas solares en este momento|Si bien el ayuntamiento de [MUNICIPIO] no ofrece actualmente deducción de IBI por fotovoltaica|Pese a la falta de bonificaciones locales de IBI en [MUNICIPIO] actualmente}, {la subvención autonómica del programa [PROGRAMA] con hasta el [PCT]%|el incentivo del [PCT]% para placas solares en [CCAA]} {ya garantiza una rentabilidad excelente para tu vivienda|sigue siendo un apoyo financiero masivo para tu instalación fotovoltaica}.
{Para maximizar el ahorro económico inicial|Si quieres optimizar tu inversión en paneles solares}, {es fundamental verificar si existen bonificaciones en el ICIO|consultar con empresas de instalaciones solares sobre el descuento en el Impuesto sobre Construcciones e Instalaciones (ICIO)} en [MUNICIPIO], {que suele ser del 95% en muchas localidades|lo que reduce el coste de las tasas municipales por instalar placas}. {Además, recuerda que la deducción del IRPF por eficiencia energética es siempre aplicable|No olvides que puedes desgravarte tu instalación solar en la declaración del IRPF, aumentando el retorno de la inversión de forma inmediata}.`,
